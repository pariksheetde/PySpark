...
if __name__ == "__main__":
    print("Package : BigData, Script : Indian Premier League Analysis 2")

spark = SparkSession.builder.appName("Indian Premier League Analysis 2").master("local[3]").getOrCreate()
...
bat_bowl_df.show(10, truncate = False)
print(f"Records Effected : {bat_bowl_df.count()}")
