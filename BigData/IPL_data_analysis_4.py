...
if __name__ == "__main__":
    print("Package : BigData, Script : Indian Premier League Analysis 4")

spark = SparkSession.builder.appName("Indian Premier League Analysis 4").master("local[3]").getOrCreate()
...
filtered_ipl_df = (bat_bowl_df.where("winner like 'Kolkata%'")
      .filter("result = 'runs'")
      .filter("city != 'Kolkata' and eliminator = 'N'")).distinct()
