...
def compute_fifa_stats(spark):
    ...
    all_fifa_cln_up_df = sel_fifa.selectExpr("Year", "Datetime", "RoundRobin", "City", "Home_Team_Name", "Away_Team_Name", "Home_Team_Goals",
...
if __name__ == "__main__":
    ...
    transformed_df = compute_fifa_stats(spark)
