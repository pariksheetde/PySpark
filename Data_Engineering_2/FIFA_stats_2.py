...
if __name__ == "__main__":
    print("Package : Data_Engineering_2, Script : FIFA World Cup Analysis 2")

spark = SparkSession.builder.appName("FIFA World Cup Analysis 2").master("local[3]").getOrCreate()
...
print(f"Records effected: {all_fifa_cln_up.count()}")
spark.stop()